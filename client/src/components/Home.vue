    ...
    <div id="base">
      ...
      <ul id="sglist">
        <li
          ...
          :key="idx"
          v-on:mouseover="fadeIn(idx)"
          v-on:mouseleave="fadeOut(idx)"
        >
          ...
          <div id="rate" v-if="suggestion.active || suggestion.rating">
            ...
            <div id="rating">
              ...
              >You have selected {{ suggestion.rating }} stars</p>
      ...
      <BModal v-model="showModal" title="Thank You">
        <p class="my-4">
          Thank you for telling us what you like Click on Next to see our
          Recommendations
        </p>
        <div class="text-center">
          <b-button variant="primary" @click="submit">Next</b-button>
        </div>
